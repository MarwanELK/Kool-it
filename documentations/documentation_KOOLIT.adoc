...
=== V0.2 :
- Grande feature 1 : Création d'une liste de courses 
...
- Petite feature 1 : Faire varier la quantité d'ingrédient en fonction du nombre de personne
...
=== V1.0 :
- Grande feature 1 : à venir
- Grande feature 2 : à venir
- Petite feature 1 : à venir
- Petite feature 2 : à venir
