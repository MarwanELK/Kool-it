...
export class ProduitsComponent implements OnInit {
  ...
  nouveauCommentaire: any = { auteur: '', texte: '' };
  ...
  ajouterCommentaire(recettes: any){
    recettes.commentaires.push({
    auteur: this.nouveauCommentaire.auteur,
    texte: this.nouveauCommentaire.texte
  });
  this.nouveauCommentaire = { auteur: '', texte: '' };
  }
}
